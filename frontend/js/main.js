...
async function login() {
    ...
    try {
        ...
        showMessage("No fue posible conectar con el servicio de autenticacion.", true);
    }
}
...
async function load() {
    ...
    if (!response.ok) {
        list.innerHTML = "<tr><td colspan=\"3\" class=\"text-danger\">No se pudieron cargar los datos de la bóveda.</td></tr>";
