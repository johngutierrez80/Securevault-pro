...
- Deploy: se ejecuta manualmente con `workflow_dispatch`, eligiendo el tag de imagen.
...
- Image scan: Trivy sobre imágenes publicadas.
...
- Shift-left local: pre-commit con Gitleaks y validaciones básicas en `.pre-commit-config.yaml`.
